...
from rango.views import AboutView, AddCategoryView, IndexView
from rango.views import ShowCategoryView, AddPageView, RestrictedView
from rango.views import GoToView, RegisterProfileView, ProfileView, ListProfilesView
