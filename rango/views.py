...
from rango.forms import UserProfile
...
class SearchAddPageView(View):
    ...
    def get(self, request):
        ...
        try:
            ...
            return HttpResponse('Error - bag category ID.')
...
def add_category(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form.save(commit=True)
            #Now the the category is saved, we could confirm this.
...
def show_category(request, category_name_slug):
    ...
    try:
        ...
        # The filter() will return a list of pages objects or an empty list.
        pages = Page.objects.filter(category=category).order_by('-views')
...
def index(request):
    ...
    # Order the categories by the number of likes in descenging order
